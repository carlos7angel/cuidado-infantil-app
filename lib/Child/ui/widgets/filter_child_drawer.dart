...
class FilterChildDrawer extends StatelessWidget {
  const FilterChildDrawer({super.key});

  @override
  Widget build(BuildContext context) {
    return GetBuilder<ChildListController>(
      id: 'list_child',
      builder: (controller) {
        return Drawer(
          child: SafeArea(
                        ...
                        children: controller.rooms.isEmpty
                            ...
                            : controller.rooms.map((room) {
                                ...
                                return CheckboxListTile(
                                  ...
                                  // secondary: Icon(UiIcons.layers, size: 20.sp, color: Theme.of(context).colorScheme.secondary,),
                                  title: Text(
                                    room.name,
